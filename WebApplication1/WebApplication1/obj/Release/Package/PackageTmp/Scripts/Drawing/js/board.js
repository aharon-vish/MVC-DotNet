...
DrawingBoard.Board = function(id, opts) {
	...
	var tpl = '<div class="drawing-board-canvas-wrapper"></canvas><canvas class="drawing-board-canvas" id="GreetingImg"></canvas><div class="drawing-board-cursor drawing-board-utils-hidden"></div></div>';
...
DrawingBoard.Board.prototype = {
	...
	downloadImg: function () {
		...
		var img = this.getImg();
		img = img.replace("image/png", "image/png");
